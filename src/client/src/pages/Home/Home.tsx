        ...
        <Container>
          <Typography variant="body1" color="textPrimary">
            ...
            <p>
              ...
              кожзаменители, применяемые для обивки, обладают высокой
              прочностью, стойкостью к истиранию. Срок службы мягкой мебели не
              менее 10 лет, гарантийный срок службы – 18 месяцев.
            </p>
            ...
            <p>
              ...
              обеспечивает полную безопасность: мягкие углы мебели, все
              соединения сделаны очень устойчиво.
            </p>
            ...
            <p>
              ...
              через платежный терминал - по карточке, в безналичном порядке
              через систему «Расчет» (ЕРИП), либо через интернет-банк
              (Произвольный платеж). Работаем по картам рассрочек "Халва",
              "Карта покупок", "KartoFUN".
            </p>
          </Typography>
        </Container>
